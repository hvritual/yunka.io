...
| AG-06.1 | Implementation introduced; exact verification/review/integration: [PR #179](https://github.com/hvritual/yunka.io/pull/179), parent #178 OPEN | Plan-first, create-only leaf Application starter, canonical generated interface, hidden use-case handlers, explicit factory policy and task/ADR templates. [Contract](architecture/APPLICATION-IMPLEMENTATION-STARTER.md), parent #178. Not a completed business implementation or whole AG-06 delivery |
| AG-06.2–AG-06.3 and AG-07 through AG-09 | Defined, not delivered | Default authoring/source-policy integration, typed-dependency/continuous-template qualification, migration/debt-growth and batch refactoring |
