...
| AG-05 | Complete / qualified / merged; exact qualification/integration record: [PR #176](https://github.com/hvritual/yunka.io/pull/176), issue #175 | Opt-in physical source inventory, explicit module/build profiles, read-only Go-native import policy and full-source/analysis-completeness distinction. [Contract](architecture/APPLICATION-SOURCE-POLICY.md). Real legacy consumer findings remain findings, not invented full-repository PASS. Accepted main `2e5ab1179d18c17de0f1ec4d59e5db2a7c08e5ea`, tree `5335703c874ee003e224edf178e2a45e8aa70e91`; PR #176 records eight successful candidate/main runs, five resolved review threads, issue #175 completed |
| AG-06.1 | Complete / qualified / merged through [PR #179](https://github.com/hvritual/yunka.io/pull/179); parent #178 OPEN | Plan-first, create-only leaf Application starter, canonical generated interface, hidden use-case handlers, explicit factory policy and task/ADR templates. Accepted main `d6840be86c72ea91b51e7f32f8ed61067bcab643`, tree `f335943aa8b291cef334e2ba418ffc1b3ca3bee7`; candidate and actual-main CI/Production/source-policy/template gates all passed. [Contract](architecture/APPLICATION-IMPLEMENTATION-STARTER.md). Not a completed business implementation or whole AG-06 delivery |
| AG-06.2 | Implementation in progress under issue #180 | Default `init/context/ownership/change plan/add operation/source-policy` integration for the same sealed-v1 layout without a second registry. [Contract](architecture/APPLICATION-DEFAULT-GOVERNANCE.md). Exact qualification/integration belongs to its delivery PR; not yet accepted on main |
| AG-06.3 and AG-07 through AG-09 | Defined, not delivered | Typed-dependency/continuous-template qualification, migration/debt-growth and batch refactoring |
