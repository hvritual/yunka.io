...
func renderAssemblyRuntimeDeclarations(routes []string, rpcClientConfigured bool, rpcServerCount int) string {
	...
	b.WriteString("\t\tBuild: func() (Applications, error) { return BuildApplications(options.Factories, options.Executor) },\n")
	b.WriteString("\t\tRegister: func(applications Applications) error { return RegisterTransports(options.Transports, applications, options.Executor) },\n")
	b.WriteString("\t})\n}\n")
	return b.String()
}
