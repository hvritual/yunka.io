 ...
 * @Description:
 *
 * @Copyright 2022 - Powered By 云咖
 * @Author: fworld
 * @Date:  2022/1/14 下午9:52
 * @Version V1.0
 */
...
func (this *Ntp) Parse(bf []byte, useUnixSec bool) {
	...
	if useUnixSec {
		this.ReferenceTimestamp = (this.ReceiveTimestamp >> 32) - UnixStaTimestamp
		if this.OriginateTimestamp > 0 {
			this.OriginateTimestamp = (this.OriginateTimestamp >> 32) - UnixStaTimestamp
		}
		this.ReceiveTimestamp = (this.ReceiveTimestamp >> 32) - UnixStaTimestamp
		this.TransmitTimestamp = (this.TransmitTimestamp >> 32) - UnixStaTimestamp
	}
}