...
func Command() cli.Command {
	return cli.Command{
		...
		Flags: []cli.Flag{
			...
			cli.BoolFlag{Name: "full", Usage: "ignore fast-feedback evidence and run canonical full generation"},
		},
		Action: func(c *cli.Context) error {
			report, workflowErr := projectflow.GenerateIncremental(context.Background(), projectflow.Options{
				Root:       c.String("root"),
